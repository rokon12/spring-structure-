...
import com.iitdu.longunmen.apps.dao.ContactsDAO;
import com.iitdu.longunmen.apps.domain.Contact;
import com.iitdu.longunmen.apps.validator.ContactFormValidator;
...
public class ContactsControllers
{
	...
	public String searchContacts(@RequestParam(required= false, value="") String name, Model model)
	{
		List<Contact> contacts = contactsDAO.searchContacts(name.trim());
		//mav.addObject("SEARCH_CONTACTS_RESULTS_KEY", contacts);
		model.addAllAttributes(contacts);
		return "";
	}
